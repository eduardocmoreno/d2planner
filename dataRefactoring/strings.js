const strings = [
  ...
  [
    "A2Q1EarlyReturnWarrivAct2",
    "90\nDeath is not afraid of the living, but the \nliving abhor death.\n"
  ],
  [
    "A2Q1EarlyReturnMeshif",
  ...
  [
    "A2Q3EarlyReturnJerhyn",
    "130\nThis eclipse is a definite manifestation \nof evil.\n"
  ],
  [
    "A2Q3EarlyReturnGreiz",
  ...
  [
    "A2Q5SuccessfulGeglash",
    "60\nThe way I see it... Well, it's all pretty \nblurry.\n"
  ],
  [
    "A2Q5SuccessfulJerhyn",
  ...
  [
    "A3Q5AfterInitOrmusVA",
    "54\nYou must know that the Guardian Tower \nin the Temple City was built by the \nHoradrim for one purpose -  to hold \nMephisto. Once the Council is dead, \nyou may enter the Tower.\n"
  ],
  [
    "A3Q5AfterInitMeshifAct3",
  ...
  [
    "A3Q6AfterInitOrmusVA",
    "52\nMake haste! Though the Three are sure \nto reunite, it is uncertain as to what \nthey have planned once they do.\n \nBe cautious, my friend. Though you are \nmighty, no mortal can stand alone \nagainst the power of the Prime Evils.\n"
  ],
  [
    "A3Q6AfterInitMeshifAct3",
  ...
  [
    "A3Q6AfterInitMeshifAct3VA",
    "116\nMove quickly, my friend, and end this \ncurse once and for all!\n"
  ],
  [
    "A3Q6AfterInitAsheara",
  ...
  [
    "D2bnetHelp2a",
    "To select a Character, left-click on the Character portrait to highlight it with an aura. To deselect any highlighted character, left-click on their portrait."
  ],
  [
    "D2bnetHelpa",
    "The buttons located under the Chat Window on the left side of the screen have the following functions:"
  ],
  [
    "D2bnetHelp1",
    "SEND displays your message to everyone in your chat Channel, regardless of what character portrait is currently selected. This button is activated as soon as you start typing in the Text Box."
  ],
  [
    "D2bnetHelp2",
    "WHISPER sends your message only to the character that you have selected. This button is activated as soon as you start typing in the Text Box and have another character selected."
  ],
  [
    "D2bnetHelp3",
    "SQUELCH filters out incoming messages from the character that you have selected. Characters that you have squelched are marked with a red X graphic. This button is activated as soon as you select another character."
  ],
  [
    "D2bnetHelp4",
    "UNSQUELCH allows you to again receive incoming messages from a character that has been squelched."
  ],
  [
    "D2bnetHelp5",
    "EMOTE lets you perform an action that the whole room can <see> as represented through text."
  ],
  [
    "D2bnetHelp5a",
    "For example, if Doomhammer wants to greet all the players in the chat Channel, he could type, <waves hello.> and then click the EMOTE button. Everyone in the Channel will then receive the message, <Doomhammer waves hello.> This button is activated as soon as you start typing in the Text Box."
  ],
  [
    "D2bnetHelp6",
    "ÿc5Gray Textÿc4 indicates when someone Joins or Leaves the chat Channel."
  ],
  [
    "D2bnetHelp7",
    "ÿc7Gold Textÿc4 indicates the name of the player speaking."
  ],
  [
    "D2bnetHelp8",
    "ÿc0White Textÿc4 indicates what you or others have said out loud to the entire chat Channel."
  ],
  [
    "D2bnetHelp9",
    "ÿc2Green Textÿc4 indicates what you have <whispered> to a specific person, or any message that has been <whispered> to you, in the chat Channel."
  ],
  [
    "D2bnetHelp10",
    "ÿc3Blue Textÿc4 represents actions that have been taken by people in the chat Channel or special messages sent directly from battle.net."
  ],
  [
    "D2bnetHelp11",
    "ÿc1Red Textÿc4 represents error messages sent directly from battle.net."
  ],
  [
    "D2bnetHelp36",
    "THE DIALOGUE WINDOW"
  ...
  [
    "D2bnetHelp36a",
    "This window on the right side of the screen is used to display and enter both game and profile information. Unlike the Chat Window, this area changes depending on what function you have activated. The buttons for these functions are discussed in detail in the following section:"
  ],
  [
    "D2bnetHelp37",
    "CREATE"
  ...
  [
    "D2bnetHelp37a",
    "Lets you form a new game for other players to join. There are several choices listed below that you need to make when creating a new game, although many of them are optional."
  ],
  [
    "D2bnetHelp38",
    "Game Name is how you want your game to be displayed in the Join Game screen. It can be cryptic or descriptive, although certain words and names are restricted."
  ],
  [
    "D2bnetHelp39",
    "Password gives you the option to make your game Private. Other players who wish to join your game will need to know the password you have selected."
  ],
  [
    "D2bnetHelp40",
    "Game Description lets you say something about the game you are forming. This is a good way to advertise for the kind of player or character you want to join your game."
  ],
  [
    "D2bnetHelp41",
    "Maximum Number of Players sets a limit as to how many characters can be in your game at any one time. The default setting is 4. You can change the number of players, up to a maximum of 8, by clicking the Up or Down arrows next to the box."
  ],
  [
    "D2bnetHelp42",
    "Character Difference sets a range above and below the level of your character that other characters joining your game must fall into. The default setting is set at 4 to determine who can join your game."
  ],
  [
    "D2bnetHelp42a",
    "To set no level restrictions, click the check box next to this option. The displayed number 4 means that any character joining your game must be within 4 levels of your character. You can change the level difference by clicking the Up or Down arrows next to the box."
  ],
  [
    "D2bnetHelp43",
    "Normal, Nightmare and Hell sets the difficulty levels at which you can play. The default setting is Normal. Characters must meet certain requirements to start games with the Nightmare and Hell difficulties. Until those requirements are met, these options will be non-selectable."
  ],
  [
    "D2bnetHelp44",
    "JOIN"
  ...
  [
    "D2bnetHelp44ab",
    "Lets you enter an existing game. Games that are listed in this screen are considered Public and can be can be joined any time they have space for a player within them."
  ],
  [
    "D2bnetHelp44a",
    "Selecting a game from this list will display information on the game, including the characters and the elapsed time of the game. To join a Private game, you will be required to enter the name of the game and its assigned password."
  ],
  [
    "D2bnetHelp45",
    "CHANNEL"
  ...
  [
    "D2bnetHelp45b",
    "Lets you join an existing chat Channel or gives you the opportunity to create a Channel of your own. To enter an established Public Channel, select one from the Channels list and click the OK button. To enter a Private Channel, you will need to enter the name of the Channel that you wish to enter."
  ],
  [
    "D2bnetHelp45a",
    "If you wish to start your own Channel, enter the name of the Channel that you wish to create in the Channel Name Field. If this channel does not exist, you will automatically create that Channel."
  ],
  [
    "D2bnetHel46",
    "LADDER"
  ...
  [
    "D2bnetHelp46a",
    "Allows you to view your character's ranking in the Diablo II Ladders for your Realm."
  ],
  [
    "D2bnetHelp47",
    "The STANDARD LADDER displays the top characters, ranked by experience. The default setting displays overall rankings, but you can view sorted lists after selecting the By Class option."
  ],
  [
    "D2bnetHelp48",
    "The HARDCORE LADDER displays the top Hardcore characters, ranked by experience. The default setting displays overall rankings, but you can view sorted lists after selecting By Class option."
  ],
  [
    "D2bnetHelp49",
  ...
  [
    "D2bnetHelp12c",
    "When using advanced commands, you must use battle.net account names; referencing Diablo II character names will not work."
  ],
  [
    "D2bnetHelp12b",
    "To find the account name associated with a character, hold your mouse over that character or access the Character Profile by right clicking the character portrait."
  ],
  [
    "D2bnetHelp12a",
    "You can access any of these advanced features by entering the following commands in the Text Box where you normally type messages:"
  ],
  [
    "D2bnetHelp13",
  ...
  [
    "D2bnetHelp13b",
    "/msg <accountname>, /m <accountname>"
  ],
  [
    "D2bnetHelp13a",
    "Sends a private message to another user on battle.net"
  ],
  [
    "D2bnetHelp14",
    "/me, /emote"
  ...
  [
    "D2bnetHelp14a",
    "Allows you to perform an action in the chat room."
  ],
  [
    "D2bnetHelp15",
    "/squelch <accountname>"
  ...
  [
    "D2bnetHelp15a",
    "Allows you to ignore messages from the indicated user."
  ],
  [
    "D2bnetHelp16",
    "/unsquelch <accountname>"
  ],
  [
    "D2bnetHelp16b",
    "/unignore <accountname>"
  ],
  [
    "D2bnetHelp16a",
    "Allows you to again receive messages from this user."
  ],
  [
    "D2bnetHelp17",
    "/away <reason>"
  ...
  [
    "D2bnetHelp17a",
    "Lets other people who send you messages know that you are away from your keyboard and cannot respond. You may provide a reason for your absence, by typing it after the /away command. To turn off this auto message when you return to your keyboard, enter just /away by itself."
  ],
  [
    "D2bnetHelp18",
    "/dnd"
  ...
  [
    "D2bnetHelp18a",
    "Lets other people who send you messages know that you do not wish to be disturbed. You may provide a reason for your absence, by typing it after the /dnd command. To turn off this auto message when you return to your keyboard, enter just /dnd by itself."
  ],
  [
    "D2bnetHelp19",
  ...
  [
    "D2bnetHelp19a",
    "Takes you to the battle.net Channel of your choice. If you wanted to enter the technical support Channel, you would simply type /channel technical support. If you attempt to join a Channel that does not exist, you will automatically create that Channel."
  ],
  [
    "D2bnetHelp20",
    "/who <channelname>"
  ...
  [
    "D2bnetHelp20a",
    "Provides you with a list of the battle.net account names of the players that are currently in the requested battle.net Channel."
  ],
  [
    "D2bnetHelp21",
    "/ban <accountname>"
  ...
  [
    "D2bnetHelp21a",
    "Bans an account from entering a private Channel and can only be issued by the Channel operator. Use /unban <accountname> to allow accounts banned from a private Channel back into that Channel."
  ],
  [
    "D2bnetHelp22",
  ...
  [
    "D2bnetHelp22a",
    "Use these commands to copy, cut, and paste highlighted text. Use ctrl+a to select all text in the text field. Use ctrl+m to toggle music off/on. Use ctrl+n to paste the account name of a selected character."
  ],
  [
    "D2bnetHelp23",
    "/designate <accountname>"
  ],
  [
    "D2bnetHelp23a",
    "Designates the player of your choice to become the next Channel operator, which will take effect after the current Channel operator leaves the Channel and can only be issued by the current Channel operator."
  ],
  [
    "D2bnetHelp24",
    "/kick <accountname>"
  ...
  [
    "D2bnetHelp24a",
    "Kicks an account from a private Channel and can only be issued by the Channel operator. The kicked player, however, can immediately rejoin the channel."
  ],
  [
    "D2bnetHelp25",
    "/rejoin, resign"
  ...
  [
    "D2bnetHelp25a",
    "Causes a Channel operator to rejoin the Channel, appearing at the end/bottom of the list instead of the front/top of the list. Only the Channel operator can issue this command."
  ],
  [
    "D2bnetHelp26",
    "/whois <accountname>, /where <accountname>"
  ],
  [
    "D2bnetHelp26b",
    "/whereis <accountname>"
  ...
  [
    "D2bnetHelp26a",
    "Searches for another player in all battle.net Public Chat channels and all Blizzard games, telling you their account name, account number and current location."
  ],
  [
    "D2bnetHelp27",
    "/whoami"
  ...
  [
    "D2bnetHelp27a",
    "Provides you with your current account number and location on battle.net."
  ],
  [
    "D2bnetHelp28",
    "/d2notify"
  ...
  [
    "D2bnetHelp28a",
    "Toggles battle.net Join/Leave notifications in the Chat Channel."
  ],
  [
    "D2bnetHelp29",
    "/help, /?"
  ...
  [
    "D2bnetHelp29a",
    "Accesses the general battle.net help text."
  ],
  [
    "D2bnetHelp30",
    "/time"
  ...
  [
    "D2bnetHelp30a",
    "Provides you with the current battle.net time and your current Local time."
  ],
  [
    "D2bnetHelp31",
    "/users"
  ...
  [
    "D2bnetHelp31a",
    "Provides the number of users, games, and channels that are currently active across all of battle.net."
  ],
  [
    "D2bnetHelp32",
  ...
  [
    "D2bnetHelp32a",
    "Provides you with the Ladder statistics for other Blizzard games supported over battle.net. The program ID for each game is as follows; StarCraft < STAR>, Brood War <STARX>, and Warcraft II: battle.net Edition <W2BN>."
  ],
  [
    "D2bnetHelp33",
    "Right-clicking on your own character allows you to edit your own profile."
  ],
  [
    "D2bnetHelp34",
    "Using the 'Tab' key in the battle.net chat room cycles through the last 10 commands you have issued."
  ],
  [
    "D2bnetHelp35",
    "If you need further help, please go to the TECHNICAL SUPPORT Channel on battle.net, consult the Diablo II manual or go to the Blizzard technical support page at http://www.blizzard.com/support/"
  ],
  [
    "D2bnetHelp51",
    "BATTLE.NET COMMANDS"
  ...
  [
    "To The Moo Moo Farm",
    "To The Secret Cow Level"
  ],
  [
    "To Chaos Sanctum",
    "To The Chaos Sanctuary"
  ],
  [
    "To The River of Flame",
    "To The River of Flame"
  ],
  [
    "To The Outer Steppes",
    "To The Outer Steppes"
  ],
  [
  ...
  [
    "To The Pandemonium Fortress",
    "To The Pandemonium Fortress"
  ],
  [
    "To The Durance of Hate Level 3",
    "To The Durance of Hate Level 3"
  ],
  [
  ...
  [
    "To The Durance of Hate Level 1",
    "To The Durance of Hate Level 1"
  ],
  [
    "To The Disused Reliquary",
    "To The Disused Reliquary"
  ],
  [
    "To The Ruined Fane",
  ...
  [
    "To The Forgotten Temple",
    "To The Forgotten Temple"
  ],
  [
    "To The Forgotten Reliquary",
    "To The Forgotten Reliquary"
  ],
  [
    "To The Disused Fane",
  ...
  [
    "To The Flayer Dungeon Level 3",
    "To The Flayer Dungeon Level 3"
  ],
  [
    "To The Swampy Pit Level 3",
    "To The Swampy Pit Level 3"
  ],
  [
  ...
  [
    "To The Swampy Pit Level 1",
    "To The Swampy Pit Level 1"
  ],
  [
    "To The Spider Cave",
    "To The Arachnid Lair"
  ],
  [
    "To The Spider Cavern",
    "To The Spider Cavern"
  ],
  [
    "To Travincal",
  ...
  [
    "To The Halls of the Dead Level 3",
    "To The Halls of the Dead Level 3"
  ],
  [
  ...
  [
    "To The Claw Viper Temple Level 1",
    "To The Claw Viper Temple Level 1"
  ],
  [
  ...
  [
    "To The Halls of the Dead Level 1",
    "To The Halls of the Dead Level 1"
  ],
  [
    "To The Stony Tomb Level 1",
    "To The Stony Tomb Level 1"
  ],
  [
    "To The Palace Cellar Level 3",
    "To The Palace Cellar Level 3"
  ],
  [
  ...
  [
    "To The Harem Level 1",
    "To The Harem Level 1"
  ],
  [
    "To The Sewers Level 3",
    "To The Sewers Level 3"
  ],
  [
  ...
  [
    "To The Sewers Level 1",
    "To The Sewers Level 1"
  ],
  [
    "To The Canyon of the Magi",
    "To The Canyon of the Magi"
  ],
  [
    "To The Valley of Snakes",
    "To The Valley of Snakes"
  ],
  [
    "To The Lost City",
  ...
  [
    "qstsa2q31",
    "Look for the source of the darkness."
  ],
  [
    "qstsa2q31a",
  ...
  [
    "qstsa3q31a",
    "Ask around the Docks about the Gidbinn."
  ],
  [
    "qstsa3q51a",
  ...
  [
    "qstsa3q61a",
    "Ormus has news about the Guardian."
  ],
  [
    "qstsa4q11",
  ...
  [
    "EnterMonasteryAma",
    "So, this is the site of Andariel's atrocities."
  ],
  [
    "EnterMonasteryBar",
  ...
  [
    "EnterJailNec",
    "Ah, the slow torture of caged starvation."
  ],
  [
    "Barracksremoved",
    "Removed"
  ...
  [
    "FindingInifusNec",
    "This tree shines with inner spirits."
  ],
  [
    "FindingCairnAma",
  ...
  [
    "FindingCairnBar",
    "These magic stones are ancient."
  ],
  [
    "FindingCairnPal",
  ...
  [
    "FindingCairnNec",
    "I sense many spirits around the stones."
  ],
  [
    "FindingTristramAma",
  ...
  [
    "CompletingForgottenTAma",
    "The Tower's trove... for the taking!"
  ],
  [
    "CompletingForgottenTBar",
  ...
  [
    "CompletingForgottenTSor",
    "I hope to find other such treasures!"
  ],
  [
    "CompletingForgottenTNec",
    "Treasure hunting... bah... Treasure finding... yes."
  ],
  [
    "CompletingAndarielAma",
    "This Maiden shall inflict no more anguish."
  ],
  [
    "CompletingAndarielBar",
  ...
  [
    "CompletingAndarielSor",
    "The evil queen has fallen."
  ],
  [
    "CompletingAndarielNec",
  ...
  [
    "EnteringRadamentBar",
    "Ugh... The tell-tale stench of a carnivore's lair."
  ],
  [
    "EnteringRadamentPal",
  ...
  [
    "EnteringRadamentNec",
    "I sense a powerful undead being within this place."
  ],
  [
    "CompletingRadamentAma",
    "Atma has been avenged."
  ],
  [
    "CompletingRadamentBar",
    "I've just about had my fill of the walking dead."
  ],
  [
    "CompletingRadamentPal",
    "I pray that Atma will rest easy now."
  ],
  [
    "CompletingRadamentSor",
    "What a misguided monster."
  ],
  [
    "CompletingRadamentNec",
    "What a waste of undead flesh."
  ],
  [
    "BeginTaintedSunAma",
    "Great. An eclipse. This just keeps getting better and better."
  ],
  [
    "BeginTaintedSunBar",
  ...
  [
    "EnteringClawViperAma",
    "I hope I know what I'm doing!"
  ],
  [
    "EnteringClawViperBar",
    "The sun has never shone here!"
  ],
  [
    "EnteringClawViperPal",
    "Light guide my way in this accursed place."
  ],
  [
    "EnteringClawViperSor",
    "I sense strong magic within this place."
  ],
  [
    "EnteringClawViperNec",
    "This place is as dark as a tomb."
  ],
  [
    "CompletingTaintedSunAma",
    "Let there be light."
  ],
  [
    "CompletingTaintedSunBar",
    "It is good to know that the sun shines once again."
  ],
  [
  ...
  [
    "FindingSummonerBar",
    "Stand aside, old fool. I have no time for your babblings."
  ],
  [
    "FindingSummonerPal",
    "Surely the evil here has driven you mad."
  ],
  [
    "FindingSummonerSor",
  ...
  [
    "FindingSummonerNec",
    "This bumbling fool cannot be the mighty Horazon!"
  ],
  [
    "CompletingSummonerAma",
    "Good riddance, freak."
  ],
  [
    "CompletingSummonerBar",
    "I hate staining my hands with the blood of foul sorcerers."
  ],
  [
    "CompletingSummonerPal",
    "Rest in peace, tortured soul."
  ],
  [
    "CompletingSummonerSor",
    "That couldn't have been Horazon. Poor wretch."
  ],
  [
    "CompletingSummonerNec",
  ...
  [
    "FindingdecoyTombBar",
    "This tomb is very ornate. This must be Tal Rasha's resting place."
  ],
  [
    "FindingdecoyTombPal",
    "Is this the tomb I seek?"
  ],
  [
    "FindingdecoyTombSor",
    "This tomb has Horadric markings. I wonder if this is Tal Rasha's tomb?"
  ],
  [
    "FindingdecoyTombNec",
    "This could be Tal Rasha's tomb. However, I'm sensing very strange energies here."
  ],
  [
    "FindingTrueTombAma",
    "Should I enter...?  Diablo and Baal may have laid a trap..."
  ],
  [
    "FindingTrueTombBar",
    "Such a cold breeze... Tal Rasha must be kept here."
  ],
  [
    "FindingTrueTombPal",
  ...
  [
    "FindingTrueTombNec",
    "I sense an incredible aura about this tomb. The Horadrim hid something powerful inside."
  ],
  [
    "CompletingTombAma",
    "This is not good. Will this madness ever end?"
  ],
  [
    "CompletingTombBar",
  ...
  [
    "FindingLamEsenAma",
    "I hope the secrets within this book can help us."
  ],
  [
    "FindingLamEsenBar",
    "I hope this book is worth all the trouble."
  ],
  [
    "FindingLamEsenPal",
    "The Black Book... It's heresy to the Zakarum High Council."
  ],
  [
    "FindingLamEsenSor",
  ...
  [
    "FindingLamEsenNec",
    "This ancient book radiates arcane power!"
  ],
  [
    "CompletingLamEsenAma",
    "All this trouble over a tattered book."
  ],
  [
    "CompletingLamEsenBar",
    "May this book lift the shadow from Kurast."
  ],
  [
    "CompletingLamEsenPal",
    "May the Black Book deliver us from evil!"
  ],
  [
    "CompletingLamEsenSor",
    "May the Black Book bring a black day to hell!"
  ],
  [
    "CompletingLamEsenNec",
    "Once the book has served its purpose, I shall delve into its secrets."
  ],
  [
    "FindingBeneathCityAma",
    "Whoa.... What died down here?"
  ],
  [
    "FindingBeneathCityBar",
    "Cough... The stench down here is choking!"
  ],
  [
    "FindingBeneathCityPal",
    "The smell of death... or worse... surrounds me."
  ],
  [
    "FindingBeneathCitySor",
    "It smells worse than rotting reagents down here."
  ],
  [
    "FindingBeneathCityNec",
    "It's been years since I waded through sewers for fun."
  ],
  [
    "FindingDrainLeverAma",
    "I hope this does something good..."
  ],
  [
    "FindingDrainLeverBar",
    "This will drain out some of the filth."
  ],
  [
    "FindingDrainLeverPal",
    "This appears to control the ancient valves."
  ],
  [
    "FindingDrainLeverSor",
    "This looks promising."
  ],
  [
    "FindingDrainLeverNec",
    "This looks like what I've been searching for."
  ],
  [
    "CompletingBeneathCityAma",
    "Eureka!"
  ],
  [
    "CompletingBeneathCityBar",
    "Good. Now I can get out of here and get some fresh air!"
  ],
  [
    "CompletingBeneathCityPal",
    "This trove will help lift the curse from Kurast!"
  ],
  [
    "CompletingBeneathCitySor",
    "I hope these items can aid me against the demons."
  ],
  [
    "CompletingBeneathCityNec",
    "Great. More junk. Just what I'd expect to find in a sewer..."
  ],
  [
    "CompletingBladeAma",
    "This dagger will separate the faithful from the fallen."
  ],
  [
    "CompletingBladeBar",
  ...
  [
    "FindingJadeFigAma",
    "What would this bring from the right buyer?"
  ],
  [
    "FindingJadeFigAma",
    "What a strange little statue."
  ],
  [
    "FindingJadeFigAma",
  ...
  [
    "FindingTempleAma",
    "Such a dark temple for a Religion of Light..."
  ],
  [
    "FindingTempleBar",
    "The spirits of nature have fled this dreaded place."
  ],
  [
    "FindingTemplePal",
    "This corrupted temple was once the shining heart of my religion..."
  ],
  [
    "FindingTempleSor",
  ...
  [
    "FindingTempleNec",
    "This temple exudes darkness."
  ],
  [
    "CompletingTempleAma",
    "Skatsim's reign is renewed!"
  ],
  [
    "CompletingTempleBar",
    "The dark powers here will no longer poison the land."
  ],
  [
    "CompletingTemplePal",
  ...
  [
    "FindingGuardianTowerAma",
    "This must be where Mephisto is."
  ],
  [
    "FindingGuardianTowerBar",
    "The final resting place of Hatred itself."
  ],
  [
    "FindingGuardianTowerPal",
    "This must be where the Horadrim imprisoned Mephisto."
  ],
  [
    "FindingGuardianTowerSor",
    "Ah... Mephisto's prison."
  ],
  [
    "FindingGuardianTowerNec",
    "The Tower that holds Mephisto...."
  ],
  [
    "CompletingGuardianTowerAma",
    "Success... But still there's something not right."
  ],
  [
    "CompletingGuardianTowerBar",
    "Maybe now the world will have peace."
  ],
  [
    "CompletingGuardianTowerPal",
    "The Lord of Hatred shall darken the world no longer."
  ],
  [
    "CompletingGuardianTowerSor",
    "Mephisto shall no longer darken our souls with hatred."
  ],
  [
    "CompletingGuardianTowerNec",
  ...
  [
    "FreezingIzualNec",
    "Bah! Izual was weak. He squandered his infernal power."
  ],
  [
    "Eskillname0",
    "          "
  ...
  [
    "heals Zealots and Cantors",
    "Heals Others"
  ],
  [
    "drains mana and stamina",
    "Drains Mana and Stamina"
  ],
  [
    "drains mana",
  ...
  [
    "eats and spits corspes",
    "Eats and Spits Corspes"
  ],
  [
    "homing missiles",
    "Homing Missiles Drain Mana"
  ],
  [
    "raises Stygian Dolls",
    "Raises Stygian Dolls"
  ],
  [
    "raises Soul Killers",
  ...
  [
    "VerifyTransaction9",
    "This Mercenary will replace your current one."
  ],
  [
    "TransactionResults1",
  ...
  [
    "TransactionResults2",
    "Sync error on transaction, please try again."
  ],
  [
    "TransactionResults3",
    "Invalid item detected, player will be dropped."
  ],
  [
    "TransactionResults4",
    "You do not have enough free space to do that."
  ],
  [
    "TransactionResults5",
    "You already have the maximum number of Mercenaries."
  ],
  [
    "TransactionResults6",
    "That item has just been traded."
  ],
  [
    "TransactionResults7",
    "You do not have enough room for the gold."
  ],
  [
    "TransactionResults8",
    "Something tells me that you do not have that item."
  ],
  [
    "TransactionResults9",
  ...
  [
    "TransactionResults10",
    "You do not have enough gold for that."
  ],
  [
    "TransactionResults11",
    "She cannot come right now.  Try again later."
  ],
  [
    "ItemDesc1s",
    "Your Gold: %d     Hire which Mercenary?"
  ],
  [
    "ItemDesc1t",
  ...
  [
    "strGemPlace1",
    "Can Be Inserted in Socketed"
  ],
  [
    "strGemPlace2",
    "Weapons, Shields or Helms"
  ],
  [
    "gemeffect1",
  ...
  [
    "sysmsg3",
    "%s joined our world. Diablo's minions grow stronger."
  ],
  [
    "sysmsg4",
    "%s left our world. Diablo's minions weaken."
  ],
  [
    "sysmsg3a",
    "%s(%s) joined our world. Diablo's minions grow stronger."
  ],
  [
    "sysmsg4a",
    "%s(%s) left our world. Diablo's minions weaken."
  ],
  [
    "sysmsg5",
    " is not in the game."
  ...
  [
    "sysmsg11",
    "Realm is going down in %d minutes."
  ],
  [
    "sysmsg12",
  ...
  [
    "strwhisperworked",
    "ÿc0You whispered to ÿc1%sÿc0: %s"
  ],
  [
    "syswork",
    "Working..."
  ...
  [
    "ShrId4",
    "Health Exchange Shrine"
  ],
  [
    "ShrId5",
    "Mana Exchange Shrine"
  ],
  [
    "ShrId6",
    "Armor Shrine"
  ...
  [
    "ShrId10",
    "Resist Lightning Shrine"
  ],
  [
    "ShrId11",
    "Resist Poison Shrine"
  ],
  [
    "ShrId12",
    "Skill Shrine"
  ...
  [
    "ShrMsg13",
    "Your spiritual force recovers quickly."
  ],
  [
    "ShrMsg14",
  ...
  [
    "ShrMsg16",
    "Your sense of identity is subtly changed."
  ],
  [
    "ShrMsg17",
  ...
  [
    "stsa1q3alert",
    "The Horadric Malus has been returned to the Monastery."
  ],
  [
    "stsa1q4alert",
    "The scroll of Inifuss has been returned to the Tree."
  ],
  [
    "stsa3q1alert",
    "The minions of Diablo have taken back Lam Esen's Tome."
  ],
  [
    "qstsa1qt",
    "The Townspeople"
  ...
  [
    "qstsa1q3x",
    "The person with the malus quit the game."
  ],
  [
    "qstsa1q4x",
    "The person with the horadric scroll quit the game."
  ],
  [
    "qstsa1q11",
    "Look for the Den in the wilderness outside the Rogues' Camp."
  ],
  [
    "qstsa1q12",
    "Kill all the monsters in the Den."
  ],
  [
    "qstsa1q13",
    ""
  ...
  [
    "qstsa1q45",
    "Cain has been rescued and is now at the Rogue Encampment."
  ],
  [
    "qstsa1q46",
  ...
  [
    "qstsa1q32",
    "Return the Horadric Malus to Charsi."
  ],
  [
    "qstsa1q32b",
    "Charsi will imbue an item with magical power."
  ],
  [
    "qstsa1q61",
    "Find Andariel's Lair in the depths of the Monastery Catacombs."
  ],
  [
    "qstsa1q62",
    "Kill Andariel."
  ...
  [
    "qstsa1q62b",
    "Return to Warriv to take the Caravan East."
  ],
  [
    "qstsa1q63",
    "Return to Warriv to take the Caravan East."
  ...
  [
    "ShorthandKeyLeftWindows",
    "lwn"
  ],
  [
    "ShorthandKeyRightWindows",
    "rwn"
  ],
  [
    "ShorthandKeyApps",
  ...
  [
    "ShorthandKeyMacOption",
    "Opt"
  ],
  [
    "ShorthandKeyMacCommand",
    "Cmd"
  ],
  [
    "ShorthandKeyMacNumPad=",
    "NP="
  ],
  [
    "CfgFunction",
  ...
  [
    "CantAssignMB",
    "Cannot assign to mouse button"
  ],
  [
    "CantAssignMW",
    "Cannot assign to mouse wheel"
  ],
  [
    "CantAssignKey",
    "Cannot assign to this key"
  ],
  [
    "CfgClearKey",
    "Clear key"
  ...
  [
    "strCannotDoThisToUnknown",
    "Cannot repair unidentified items"
  ],
  [
    "Body Looted",
    "Body Looted"
  ...
  [
    "Party1",
    " permits you to loot his corpse."
  ],
  [
    "Party2",
    " permits you to loot her corpse."
  ],
  [
    "Party3",
    " has expressed hostility towards you."
  ],
  [
    "Party4",
    " is no longer hostile towards you."
  ],
  [
    "Party5",
    " invites you to ally against the forces of evil."
  ],
  [
    "Party6",
    " has cancelled the party invite."
  ],
  [
    "Party7",
    " has joined your party to fight the forces of evil."
  ],
  [
    "Party8",
    "You are now allied with "
  ],
  [
    "Party9",
    " has left your party."
  ...
  [
    "strDropGoldHowMuch",
    "How much Gold would you like to drop?"
  ],
  [
    "strDropGoldInfo",
    "Drop Gold"
  ...
  [
    "strWaitingForOtherPlayer",
    "asking other player to trade"
  ],
  [
    "strTradeBusy",
    " is busy"
  ...
  [
    "strTradeTimeout",
    "You must wait a short time to trade with that player."
  ],
  [
    "SysmsgPlayer1",
    ": "
  ...
  [
    "strParty3",
    "Accept this player's "
  ],
  [
    "strParty4",
    "invitation to form a party."
  ],
  [
    "strParty5",
  ...
  [
    "strParty13",
    "Click to disallow this player"
  ],
  [
    "strParty14",
    "from looting your corpse."
  ],
  [
    "strParty15",
    "Click to allow this player"
  ...
  [
    "strParty19",
    "Click to squelch this player."
  ],
  [
    "strParty22",
    "Click to un-squelch this player."
  ],
  [
    "strParty24",
    "Remove yourself from party."
  ],
  [
    "strParty25",
    "Must be toggled in town."
  ],
  [
    "StrParty26",
  ...
  [
    "strUnknownTomb",
    "The True Tomb is Hidden."
  ],
  [
    "strTradeOtherBox",
    " has items in his box."
  ],
  [
    "strTradeBox",
    "You have items in your box."
  ],
  [
    "strFree",
    " - Free for you"
  ...
  [
    "charmontohit1",
    "Average chance a level %d"
  ],
  [
    "charmontohit2",
    "monster will hit you: %d%%"
  ],
  [
    "panelexp",
    "Experience: %u / %u"
  ...
  [
    "StrHelp3",
    "Hold down <%s> to highlight items on the ground"
  ],
  [
    "StrHelp4",
    "Hold down <%s> to attack while standing still"
  ],
  [
    "StrHelp5",
    "Hit <%s> to toggle the automap on and off"
  ],
  [
    "StrHelp6",
  ...
  [
    "StrHelp8",
    "Use F1-F8 to set your Left or Right Mouse Button Skills."
  ],
  [
    "StrHelp8a",
    "Hit <%s> to toggle this screen open and closed"
  ],
  [
    "StrHelp9",
    "Life Orb"
  ...
  [
    "StrSkill118",
    "You have been granted this skill by an item"
  ],
  [
    "StrSkill119",
  ...
  [
    "skillsd8",
    "illuminates and weakens nearby monsters"
  ],
  [
    "skillld8",
  ...
  [
    "skillsd9",
    "passive - chance of doing double damage"
  ],
  [
    "skillld9",
  ...
  [
    "skillsd10",
    "rapid attacks with a thrusting weapon"
  ],
  [
    "skillld10",
  ...
  [
    "skillsd11",
    "enchants arrows to slow targets"
  ],
  [
    "skillld11",
  ...
  [
    "skillsd17",
    "slows ranged attacks of enemies"
  ],
  [
    "skillld17",
  ...
  [
    "skillsd18",
    "passive - dodges missiles"
  ],
  [
    "skillld18",
    "when attacking or standing still\npassive - you have a chance to dodge enemy missiles"
  ],
  [
    "skillan18",
    "Avoid"
  ...
  [
    "skillsd19",
    "increases damage but degrades weapon"
  ],
  [
    "skillld19",
  ...
  [
    "skillsd20",
    "changes a thrown javelin into lightning"
  ],
  [
    "skillld20",
  ...
  [
    "skillsd21",
    "enchants arrows to freeze enemies"
  ],
  [
    "skillld21",
  ...
  [
    "skillsd22",
    "enchants arrows to seek enemies"
  ],
  [
    "skillld22",
  ...
  [
    "skillsd23",
    "passive - increases attack rating"
  ],
  [
    "skillld23",
  ...
  [
    "skillsd24",
    "enchants thrusting weapons with charged bolts"
  ],
  [
    "skillld24",
  ...
  [
    "skillsd25",
    "enchants javelins with poison explosions"
  ],
  [
    "skillld25",
  ...
  [
    "skillsd26",
    "enchants arrows to strike multiple targets"
  ],
  [
    "skillld26",
  ...
  [
    "skillsd31",
    "enchants arrows to freeze multiple monsters"
  ],
  [
    "skillld31",
  ...
  [
    "skillsd33",
    "passive - missiles may continue through enemies"
  ],
  [
    "skillld33",
  ...
  [
    "skillsd34",
    "enchants thrusting weapons with chain lightning"
  ],
  [
    "skillld34",
  ...
  [
    "skillsd35",
    "a lightning bolt that splits on impact"
  ],
  [
    "skillld35",
  ...
  [
    "skillsd37",
    "passive - increases mana recovery rate"
  ],
  [
    "skillld37",
  ...
  [
    "skillsd38",
    "creates multiple deadly sparks"
  ],
  [
    "skillld38",
    "bolts of electrical energy\ncreates multiple, randomly directed"
  ],
  [
    "skillan38",
    "Charged Bolt"
  ...
  [
    "skillsd39",
    "creates a shard of ice that slows enemies"
  ],
  [
    "skillld39",
    "that damages and slows your enemies\ncreates a magical bolt of ice"
  ],
  [
    "skillan39",
    "Ice Bolt"
  ...
  [
    "skillsd40",
    "improves defense and freezes attacker"
  ],
  [
    "skillld40",
    "and freezes enemies that hit you\nincreases your defense rating"
  ],
  [
    "skillan40",
    "Frozen Armor"
  ...
  [
    "skillsd42",
    "creates a field of deadly sparks"
  ],
  [
    "skillld42",
    "of all nearby enemies by one third\ncreates an electrical field that reduces life"
  ],
  [
    "skillan42",
    "Static Field"
  ...
  [
    "skillsd45",
    "creates an ice bolt that freezes enemies"
  ],
  [
    "skillld45",
    "damages and freezes your enemy\ncreates a magical sphere of ice that"
  ],
  [
    "skillan45",
    "Ice Blast"
  ...
  [
    "skillsd46",
    "creates fire in your wake"
  ],
  [
    "skillld46",
    "in your wake to scorch your enemies\ncreates a wall of fire"
  ],
  [
    "skillan46",
    "Blaze"
  ...
  [
    "skillsd47",
    "creates an explosive sphere of fire"
  ],
  [
    "skillld47",
    "to engulf your enemies\ncreates an explosive sphere of fiery death"
  ],
  [
    "skillan47",
    "Fire Ball"
  ...
  [
    "skillsd48",
    "creates an electrically charged ring"
  ],
  [
    "skillld48",
  ...
  [
    "skillsd52",
    "enchants melee or ranged weapons with fire"
  ],
  [
    "skillld52",
  ...
  [
    "skillsd53",
    "creates a bolt of lightning that arcs"
  ],
  [
    "skillld53",
    "arcs through several targets\ncreates a bolt of lightning that"
  ],
  [
    "skillan53",
    "Chain Lightning"
  ...
  [
    "skillsd54",
    "instantly moves to destination"
  ],
  [
    "skillld54",
  ...
  [
    "skillsd55",
    "creates a freezing comet of ice"
  ],
  [
    "skillld55",
    "that freezes or kills nearby enemies\ncreates a magical ice comet"
  ],
  [
    "skillan55",
    "Glacial Spike"
  ...
  [
    "skillld56",
    "to crush and incinerate your enemies\nsummons a meteor from the heavens"
  ],
  [
    "skillan56",
    "Meteor"
  ...
  [
    "skillsd57",
    "summons a powerful tempest"
  ],
  [
    "skillld57",
    "your enemies with bolts of lightning\nsummons a deadly thunderstorm that strikes"
  ],
  [
    "skillan57",
    "Thunder Storm"
  ...
  [
    "skillsd58",
    "uses your mana as a shield"
  ],
  [
    "skillld58",
    "instead of health when you take damage\ncreates a magical shield that consumes mana"
  ],
  [
    "skillan58",
    "Energy Shield"
  ...
  [
    "skillsd60",
    "retaliates against ranged attackers"
  ],
  [
    "skillld60",
  ...
  [
    "skillsd62",
    "summons multi-headed fire beast"
  ],
  [
    "skillld62",
  ...
  [
    "skillsd63",
    "passive - reduces cost of lightning spells"
  ],
  [
    "skillld63",
    "to cast your lightning spells\npassive - reduces the mana required"
  ],
  [
    "skillan63",
    "Lightning Mastery"
  ...
  [
    "skillsd64",
    "creates a globe of frozen death"
  ],
  [
    "skillld64",
  ...
  [
    "skillsd65",
    "passive - cold attacks become piercing"
  ],
  [
    "skillld65",
  ...
  [
    "skillsd69",
    "passive - better skeletons and revived creatures"
  ],
  [
    "skillld69",
  ...
  [
    "skillld74",
    "it explodes, damaging nearby enemies\ncast on the corpse of a slain monster,"
  ],
  [
    "skillan74",
    "Corpse Exp."
  ...
  [
    "skillld76",
    "to damage themselves when damaging others\ncurses a group of enemies, causing them"
  ],
  [
    "skillan76",
    "Iron Maiden"
  ...
  [
    "skillld82",
    "damaging them gives the attacker life\ncurses a group of monsters so that"
  ],
  [
    "skillan82",
    "Life Tap"
  ...
  [
    "skillsd89",
    "passive - summoned monsters gain resistances"
  ],
  [
    "skillld89",
  ...
  [
    "skillld97",
    "by bashing it with your shield\ntemporarily stun your enemy"
  ],
  [
    "skillan97",
    "Smite"
  ...
  [
    "skillsd101",
    "divine energy that damages undead"
  ],
  [
    "skillld101",
  ...
  [
    "skillsd102",
    "aura - flames damage nearby enemies"
  ],
  [
    "skillld102",
  ...
  [
    "skillsd103",
    "aura - reflects damage back at enemies"
  ],
  [
    "skillld103",
  ...
  [
    "skillsd106",
    "attacks multiple adjacent enemies"
  ],
  [
    "skillld106",
  ...
  [
    "skillsd108",
    "aura - increases your attack rating"
  ],
  [
    "skillld108",
  ...
  [
    "skillsd112",
    "summon a spiraling magic hammer"
  ],
  [
    "skillld112",
  ...
  [
    "skillsd113",
    "aura - increases your attack ability"
  ],
  [
    "skillld113",
  ...
  [
    "skillsd116",
    "Change allegiance of monsters"
  ],
  [
    "skillld116",
    "other foul demons and beasts\nconverts monsters to fight against"
  ],
  [
    "skillan116",
    "Conversion"
  ...
  [
    "skillsd118",
    "aura - lightning damages nearby enemies"
  ],
  [
    "skillld118",
  ...
  [
    "skillsd119",
    "aura - repels and damages undead"
  ],
  [
    "skillld119",
  ...
  [
    "skillsd123",
    "aura  - weakens enemies"
  ],
  [
    "skillld123",
    "and resistances of nearby enemies\nwhen active, aura reduces the defenses"
  ],
  [
    "skillan123",
    "Conviction"
  ...
  [
    "skillsd126",
    "powerful blow that increases damage"
  ],
  [
    "skillld126",
  ...
  [
    "skillsd131",
    "targets corpses to find potions"
  ],
  [
    "skillld131",
    "for a chance to find a potion\nuse on the corpse of a slain monster"
  ],
  [
    "skillan131",
    "Find Potion"
  ...
  [
    "skillsd138",
    "alerts party and improves defense"
  ],
  [
    "skillld138",
  ...
  [
    "skillsd143",
    "leaps and attacks target enemy"
  ],
  [
    "skillld143",
    "in one swift assault\nleaps to and attacks target enemy"
  ],
  [
    "skillan143",
    "Leap Attack"
  ...
  [
    "skillsd144",
    "attack that is not interruptible"
  ],
  [
    "skillld144",
    "improves attack and defense rating\nattack that is not interruptible and"
  ],
  [
    "skillan144",
    "Concentrate"
  ...
  [
    "skillsd146",
    "reduces enemy effectiveness"
  ],
  [
    "skillld146",
    "enemies defense rating and damage\nfearsome cry that decreases"
  ],
  [
    "skillan146",
    "Battle Cry"
  ...
  [
    "skillsd149",
    "improves life, mana and stamina of party"
  ],
  [
    "skillld149",
    "stamina of you and your party\nimproves the maximum mana, life and"
  ],
  [
    "skillan149",
    "Battle Orders"
  ...
  [
    "skillsd150",
    "creates a frightening totem"
  ],
  [
    "skillld150",
    "that causes nearby monsters to flee\nto create a frightening totem\nuse on the corpse of a slain monster"
  ],
  [
    "skillan150",
    "Grim Ward"
  ...
  [
    "skillld153",
    "to elemental and poison damage\npassive - increases natural resistances"
  ],
  [
    "skillan153",
    "Natural Resistance"
  ...
  [
    "skillsd154",
    "injures and stuns nearby enemies"
  ],
  [
    "skillld154",
  ...
  [
    "skillsd217",
    "identify a magic item's properties"
  ],
  [
    "skillld217",
    "identify a magic item's properties"
  ...
  [
    "skillsd219",
    "create a magic portal to the nearest town"
  ],
  [
    "skillld219",
    "create a magic portal to the nearest town"
  ...
  [
    "strMephistoDoorLocked",
    "Ormus has the key that opens this door."
  ],
  [
    "strTitleFeminine",
    "Lady %s"
  ...
  [
    "To The Catacombs Level 4",
    "To The Catacombs Level 4"
  ],
  [
    "To The Catacombs Level 3",
    "To The Catacombs Level 3"
  ],
  [
  ...
  [
    "To The Tower Cellar Level 5",
    "To The Tower Cellar Level 5"
  ],
  [
    "To The Tower Cellar Level 4",
    "To The Tower Cellar Level 4"
  ],
  [
    "To The Tower Cellar Level 3",
    "To The Tower Cellar Level 3"
  ],
  [
  ...
  [
    "To The Tower Cellar Level 1",
    "To The Tower Cellar Level 1"
  ],
  [
    "To The Forgotten Tower",
    "To The Forgotten Tower"
  ],
  [
    "To The Mausoleum",
  ...
  [
    "To Underground Passage Level 1",
    "To Underground Passage Level 1"
  ],
  [
    "To The Cave Level 1",
  ...
  [
    "Deathmessage",
    "Death takes its toll of %d Gold"
  ],
  [
    "Deathmessnight",
  ...
  [
    "x",
    "Enter Host IP Address to Join Game"
  ],
  [
    "x",
    "Your IP Address is: "
  ...
  [
    "x",
    "Click 'Host Game' to make your computer the host for a game. Other players must then enter your IP Address to connect to your computer. Only locally stored characters can be played in a hosted game."
  ],
  [
    "x",
    "Click 'Join Game', then enter the IP Address of the host computer. Only locally stored characters can be played in a hosted game."
  ],
  [
    "x",
  ...
  [
    "x",
    "There is not enough room on your Hard Disk. Please free up space and then try again."
  ],
  [
    "x",
    "CREATE GAME"
  ...
  [
    "x",
    "Hardcore and Normal Characters may not be in the same game."
  ],
  [
    "x",
    "Game does not exist."
  ...
  [
    "x",
    "Game name and password don't match."
  ],
  [
    "x",
    "Game is Full."
  ...
  [
    "x",
    "You do not meet the level restrictions for this game."
  ],
  [
    "x",
  ...
  [
    "x",
    "There is a new version of the software available. Please completely uninstall your game program, reinstall from your original CD, and reconnect to Battle.net."
  ],
  [
    "x",
    "Unable to connect to Battle.net. If you are using a modem to access your service provider and are not configured for Remote Access, you may have to initiate the connection manually."
  ],
  [
    "x",
  ...
  [
    "x",
    "This application was installed using a CD Key which is not authorized for Battle.net use."
  ],
  [
    "x",
  ...
  [
    "x",
    "You are using a 16-bit connection to your Internet Service Provider."
  ],
  [
    "x",
    "Battle.net requires a 32-bit connection to the Internet. Please make sure that you are using the most current connection software from your Internet Service Provider."
  ],
  [
    "x",
    "Unable to open a TCP/IP connection. Make sure that OpenTransport is installed correctly. You may also need to connect to your Internet Service Provider before connecting to Battle.net."
  ],
  [
    "x",
    "Please uninstall and then reinstall the application using the CD Key from your CD case. If you still cannot connect to Battle.net, please visit www.battle.net/support/errormessages/"
  ],
  [
    "x",
    "There is a new version of software available. Battle.net requires that you use the latest version. Your software will be updated now."
  ],
  [
    "x",
    "The update has been downloaded successfully. Your application will now restart."
  ],
  [
    "x",
    "The update has been interrupted. No changes were made. Please try this process again."
  ],
  [
    "x",
    "Downloading software upgrade."
  ],
  [
    "x",
    "The CD Key that you installed with has been disabled. Please contact Blizzard Entertainment Technical Support for further assistance."
  ],
  [
    "x",
  ...
  [
    "x",
    "The CD key used to install this application was intended for another product. Please reinstall this application using the correct CD key."
  ],
  [
    "X",
    "The Realm is undergoing renovation. Please try again in 15 minutes."
  ],
  [
    "x",
    "Battle.net Log In"
  ...
  [
    "x",
    "Account name can't be more than 15 characters."
  ],
  [
    "x",
  ...
  [
    "x",
    "Password can't be more than 15 characters."
  ],
  [
    "x",
    "CREATE NEW ACCOUNT"
  ...
  [
    "x",
    "Enter the Name and Password for your new battle.net account."
  ],
  [
    "x",
    "Account Name"
  ...
  [
    "x",
    "Please note that inactive accounts are deleted at regular times. If you create a new account, you must be logged into Battle.net long enough - either in one session, or spread over several - to have accumulated 2 hours of time within the first 48 hours."
  ],
  [
    "x",
  ...
  [
    "x",
    "PLEASE WRITE DOWN YOUR PASSWORD. BLIZZARD DOES NOT HAVE ACCESS TO PASSWORDS, AND CANNOT FIND OR REPLACE FORGOTTEN PASSWORDS."
  ],
  [
    "x",
    "User names must be at least two characters in length. Please try again with a different name."
  ],
  [
    "x",
    "Your user name contained one or more illegal characters."
  ],
  [
    "x",
    "Your user name contained one or more disallowed words."
  ],
  [
    "x",
    "Your previous account creation request is still being processed. Please wait a few moments and try logging in with the account you just created."
  ],
  [
    "x",
    "Your name did not have enough alpha-numeric characters in it."
  ],
  [
    "x",
    "Your name contained too many adjacent punctuation characters in it."
  ],
  [
    "x",
    "Your name contained too many punctuation characters in it."
  ],
  [
    "x",
    "The passwords you have typed do not match. Please enter the same password twice."
  ],
  [
    "x",
    "An account already exists with the name you have chosen.  Please try again with a different name."
  ],
  [
    "x",
  ...
  [
    "x",
    "You have entered an incorrect password. If your character has not been on Battle.net for 3 months, or if you forgot your password, you can select "
  ],
  [
    "x",
    "Unable to change password. You have specified an invalid name or password."
  ],
  [
    "x",
    "Please Wait"
  ...
  [
    "x",
    "Please note that inactive characters are deleted at regular times. You must play a new character at least 2 hours within the first 48 hours."
  ],
  [
    "x",
  ...
  [
    "x",
    "No Realms are available right now, please try again later."
  ],
  [
    "x",
  ...
  [
    "x",
    "A Realm is a battle.net server that stores Secure characters and runs Secure games with those characters. A Secure character is played in only one Realm."
  ],
  [
    "x",
    "Character Storage Site"
  ],
  [
    "x",
    "Secure characters have access to all battle.net features, including Ladders, and chat portraits. You must have a working internet connection to play a Secure character."
  ],
  [
    "x",
    "WARNING: Once a Hardcore character dies, it cannot be played again. Are you sure you wish to create a Hardcore character?"
  ],
  [
    "x",
    "You cannot create or join games with a dead hardcore character."
  ],
  [
    "x",
    "SEND"
  ...
  [
    "x",
    "You have clicked on a link to the Internet. Your web browser will now be launched. You can use the Windows Taskbar to return to Battle.net."
  ],
  [
    "x",
    "You have disconnected from Battle.net. Press OK to hangup the connection to %s. Press Cancel to stay connected."
  ],
  [
    "x",
    "Battle.net was unable to launch your default browser."
  ],
  [
    "x",
    "Couldn't open this URL. The URL appears to be invalid."
  ],
  [
    "x",
    "Launching a web browser from Battle.net requires Internet Config 1.1 or newer.  Make sure Internet Config is installed on your computer."
  ],
  [
    "x",
    "The default web browser selected in Internet Config or the Internet control panel could not be located on your hard drive."
  ],
  [
    "x",
    "There is not enough free memory available to launch the web browser."
  ],
  [
    "x",
    "You have clicked on a link to the Internet. Your web browser will now be launched. Use "
  ],
  [
    "x",
    "That channel is restricted"
  ],
  [
    "x",
  ...
  [
    "x",
    "Battle.net is down. Reconnect later."
  ],
  [
    "x",
  ...
  [
    "x",
    "The connection to Battle.net has been interrupted. Please try again later."
  ],
  [
    "x",
    "You are banned from battle.net. Reconnect later."
  ],
  [
    "x",
  ...
  [
    "x",
    "A dead hardcore character cannot join or create any games."
  ],
  [
    "x",
  ...
  [
    "x",
    "Unable to enter game. Bad character version"
  ],
  [
    "x",
    "Unable to enter game. Bad character quest data"
  ],
  [
    "x",
    "Unable to enter game. Bad character waypoint data"
  ],
  [
    "x",
    "Unable to enter game. Bad character stats data"
  ],
  [
    "x",
    "Unable to enter game. Bad character skills data"
  ],
  [
    "x",
    "failed to join game"
  ...
  [
    "x",
    "Unable to enter game, bad dead bodies"
  ],
  [
    "x",
    "Unable to enter game, bad header"
  ],
  [
    "x",
  ...
  [
    "x",
    "Unable to enter game, bad intro data"
  ],
  [
    "x",
    "Unable to enter game, bad item"
  ],
  [
    "x",
    "Unable to enter game, bad dead body item"
  ],
  [
    "x",
  ...
  [
    "ModStre9j",
    "Fire Damage Reduced by"
  ],
  [
    "ModStre9k",
    "Cold Damage Reduced by"
  ],
  [
    "ModStre9l",
    "Lightning Damage Reduced by"
  ],
  [
    "ModStre9m",
    "Poison Damage Reduced by"
  ],
  [
    "ModStre9n",
  ...
  [
    "x",
    "The character '%s' has not been used for over 3 months and has expired."
  ],
  [
    "upgraderestrictEx",
  ...
  [
    "PlayerNameOnItemstring",
    "%s's"
  ],
  [
    "PlayerNameOnItemstringX",
    "%s'"
  ],
  [
    "SetItemFormatX",
  ...
  [
    "x",
    "Repair all equipment: %d"
  ],
  [
    "x",
    "No equipped items need repairing"
  ],
  [
    "Druid",
    "Druid"
  ...
  [
    "x",
    "Unable to enter game. A Diablo II character cannot join a game created by a Diablo II Expansion character."
  ],
  [
    "x",
    "Unable to enter game. A Diablo II Expansion character cannot join a game created by a Diablo II character."
  ],
  [
    "charmonsterX",
    "%s: %d%%"
  ...
  [
    "Party1X",
    "%s permits you to loot his corpse."
  ],
  [
    "Party2X",
    "%s permits you to loot her corpse."
  ],
  [
    "Party10",
    "%s no longer allows you to access his corpse."
  ],
  [
    "Party11",
    "%s no longer allows you to access her corpse."
  ],
  [
    "Party12",
    "You are hostile towards each other."
  ],
  [
    "Party13",
    "%s is hostile to you, but you are friendly to him."
  ],
  [
    "Party14",
    "%s is hostile to you, but you are friendly to her."
  ],
  [
    "Party 15",
    "%s is friendly to you, but you are hostile to him."
  ],
  [
    "Party16",
    "%s is friendly to you, but you are hostile to her."
  ],
  [
    "Party17",
    "You are friendly to each other."
  ],
  [
    "Party18",
    "You may loot each other's corpse."
  ],
  [
    "Party19",
    "%s may loot your corpse, but you may not loot his."
  ],
  [
    "Party20",
    "%s may loot your corpse, but you may not loot hers."
  ],
  [
    "Party21",
    "%s may not loot your corpse, but you may loot his."
  ],
  [
    "Party22",
    "%s may not loot your corpse, but you may loot hers."
  ],
  [
    "Party23",
    "Neither of you may loot the other's corpse."
  ],
  [
    "Civerb's Ward",
    "Civerb's Ward"
  ...
  [
    "skillxsd63",
    "passive - increases lightning damage"
  ],
  [
    "skillxld63",
  ...
  [
    "skillxsd122",
    "aura - increases attack speed and damage"
  ],
  [
    "skillxld122",
  ...
  [
    "x",
    "This application was installed using a Lord of Destruction CD Key which is not authorized for Battle.net use."
  ],
  [
    "x",
    "The Lord of Destruction CD Key that you installed with has been disabled. Please contact Blizzard Entertainment Technical Support for further assistance."
  ],
  [
    "x",
    "Your Lord of Destruction CD key is currently being used by:"
  ],
  [
    "x",
    "The Lord of Destruction CD key used to install this application was intended for another product. Please reinstall this application using the correct CD key."
  ],
  [
    "Playersubtitles29",
    "Retreat!"
  ...
  [
    "x",
    "A Ladder Character can only be played with other Ladder characters during the Ladder Season when it was created. After the Ladder Season is over, then the Ladder character will become a Non-Ladder Character. Continue?"
  ],
  [
    "x",
  ...
  [
    "CoLenplev",
    "Cold Length per Level"
  ],
  [
    "FrezLenplev",
    "Freeze Length per Level"
  ],
  [
    "PoisLenplev",
    "Poison Length per Level"
  ],
  [
    "Convphy2magplev",
    "Converts %d%% Physical Damage to Magic Damage per Level"
  ],
  [
    "Convphy2elemplev",
    "Converts %d%% Physical Damage to Elemental Damage per Level"
  ],
  [
    "Convphy2magalt",
    "Converts %d%% Physical Damage to Elemental Damage"
  ],
  [
    "Convphy2elemalt",
    "Converts %d%% Physical Damage to Magic Damage"
  ],
  [
    "Secplev1",
    "Second per Level"
  ...
  [
    "Hbdplev",
    "Holy Bolt Damage per Level"
  ],
  [
    "Healplev",
    "Life Healed per Level"
  ],
  [
    "Healplev2",
    "Life Healed Every 2 Seconds"
  ],
  [
    "FanYDam",
    "Your Damage: "
  ...
  [
    "AFDImm",
    "Average Fire Damage per Second per Level"
  ],
  [
    "Cgslow",
    "Slows Enemies: "
  ...
  [
    "Moditemskondeath",
    "%d%% Chance to cast level %d %s when you Die"
  ],
  [
    "ModitemskonLevel",
    "%d%% Chance to cast level %d %s when you Level-Up"
  ],
  [
    "ModitemskonKill",
    "%d%% Chance to cast level %d %s when you Kill an Enemy"
  ],
  [
    "Skillname224",
    "Werewolf"
  ...
  [
    "SOJSold",
    "%d Stones of Jordan Sold to Merchants"
  ],
  [
    "DiabloWalksEarth",
  ...
  [
    "D2bnetHelp10",
    "ÿc3Blue Textÿc4 represents actions that have been taken by people in the chat Channel."
  ],
  [
    "ItemStats1r",
    "Chance to Block: "
  ...
  [
    "x",
    "No new games can be created right now, Please Join a game or try later."
  ],
  [
    "merca239",
    "Jarulf"
  ...
  [
    "x",
    "You are in line to create a game. Try joining a game to avoid waiting."
  ],
  [
    "X",
    "Game Queue"
  ...
  [
    "D2bnetHelp10a",
    "ÿc9 Yellow Textÿc4 represents special messages sent directly from battle.net"
  ],
  [
    "BnetnewGameTime",
    "Game Time:"
  ...
  [
    "x",
    "A character named '%s' already exists in this Realm."
  ],
  [
    "D2bnetHelp6a",
    "ÿc5Gray Textÿc4 also represents actions that have been taken by people in the chat Channel."
  ],
  [
    "D2bnetHelp10aPatch",
    "ÿc3Blue Textÿc4 represents special messages sent directly from battle.net or messages from a Blizzard Representative."
  ],
  [
    "x",
    "SEND"
  ...
  [
    "x",
    "You cannot send your password to another user on Battle.net. Blizzard will never ask you for your password for any reason."
  ],
  [
    "x",
    "CONNECTING..."
  ...
  [
    "x",
    "You have more than 8 characters on this Diablo II Realm. Only 8 characters can be displayed at a time."
  ],
  [
    "x",
    "To see more characters, you must delete one of your existing characters. This deletion is permanent. You will not be able to recover the deleted character."
  ],
  [
    "X",
    "Terms of Service"
  ...
  [
    "eskillincasemasteryX",
    "%d Percent Chance of Critical Strike"
  ],
  [
    "CfgSay7X",
    "Say 'Retreat'"
  ...
  [
    "x",
    "Entering your email address will enable extra features, such as the ability to recover your account should you forget your password. Visit www.battle.net/email-address for more information."
  ],
  [
    "x",
    "Email Address:"
  ...
  [
    "x",
    "Please make sure that the two email addresses match."
  ],
  [
    "x",
  ...
  [
    "x",
    "Without a registered email address, you will not be able to recover your account should you forget your password. You will not have another opportunity to register an email address with this account."
  ],
  [
    "x",
    "If you have forgotten your password and you registered your email address with us for this account, you can request that a new password be sent to you by clicking Send.  Make sure to enter the email address that you registered for this account."
  ],
  [
    "x",
    "Your request for a new password has been received. If you registered an email address for this account you will receive an email with instructions on how to complete your password change."
  ],
  [
    "x",
    "CONTINUE"
  ...
  [
    "x",
    "Forgot your password? Click 'Account Settings'."
  ],
  [
    "x",
  ...
  [
    "x",
    "If you know your password and want to change it, click here."
  ],
  [
    "x",
  ...
  [
    "x",
    "If you need to change your registered email address, click here."
  ],
  [
    "x",
    "GET NEW PASSWORD"
  ...
  [
    "x",
    "If you registered an email address for this account then you can change it here. Note that both email addresses need to be active for you to make this change."
  ],
  [
    "x",
  ...
  [
    "x",
    "Please make sure that the two new email addresses match."
  ],
  [
    "x",
    "Battle.net News Updates"
  ],
  [
    "x",
    "Last Difficulty Setting Completed:"
  ],
  [
    "x",
    "None"
  ...
  [
    "x",
    "The password you've chosen is unsafe. Please choose a new one."
  ],
  [
    "x",
    "CDKEY WARNING"
  ...
  [
    "x",
    "You cannot send your cdkey to another user on Battle.net. Blizzard will never ask you for your cdkey for any reason."
  ],
  [
    "x",
    "Expires Today"
  ...
  [
    "x",
    "A Diablo II character must be played in a game, or it will eventually expire. When you first create a character, it expires 10 days after the last time it was played. Once that character has been played for two hours or more, it will not expire until three months from the time it was last played."
  ],
  [
    "x",
    "A character that expires is deleted from the realm."
  ],
  [
    "x",
    "The character '%s' has not been used enough and has expired."
  ],
  [
    "pk1",
    "Key of Terror"
  ...
  [
    "respec",
    "Reset Stat/Skill Points"
  ],
  [
    "x",
    "Persistent ignoring is now enabled."
  ],
  [
    "x",
    "Persistent ignoring is now disabled."
  ],
  [
    "x",
    "%s has been ignored."
  ...
  [
    "x",
    "%s has been unignored."
  ],
  [
    "x",
    "%s is not currently ignored."
  ],
  [
    "x",
  ...
  [
    "x",
    "Unable to remove message filter."
  ],
  [
    "strAutoGoldLabel",
    "Pickup Gold"
  ...
  [
    "skillname136x",
    "Throwing Speed Mastery"
  ],
  [
    "baseandminstatshovertip",
    "Base: %d (Min: %d)"
  ],
  [
    "SkillCategoryMisc",
    "Common Abilities and Items"
  ],
  [
    "SkillCategoryAm1",
    "Javelin and Spear"
  ...
  [
    "ModStre8d",
    " to Attack Rating vs. Demons"
  ],
  [
    "ModStre8e",
    " to Attack Rating vs. Undead"
  ],
  [
    "ModStre8f",
    " to Damage vs. Demons"
  ...
  [
    "ModStre8g",
    " percent to Attack Rating"
  ],
  [
    "ModStre8h",
    " to Javelin and Spear Skills"
  ],
  [
    "ModStre8i",
  ...
  [
    "ModStre8k",
    " to Defensive Aura Skills"
  ],
  [
    "ModStre8l",
    " to Offensive Aura Skills"
  ],
  [
    "ModStre8m",
    " to Combat Skills"
  ...
  [
    "GemeffectX52",
    "Adds to All Resistances"
  ],
  [
    "GemeffectX53",
    "Adds to Damage vs. Undead"
  ],
  [
    "GemeffectX61",
    "Adds to Chance to Find Magic Items"
  ],
  [
    "GemeffectX62",
  ...
  [
    "GemeffectX63",
    "Adds Lightning Damage to Attack"
  ],
  [
    "GemeffectX71",
    "Adds Mana and Life Regeneration"
  ],
  [
    "GemeffectX72",
    "Adds Attacker Takes Damage"
  ],
  [
    "GemeffectX73",
    "Adds Mana and Life Steal to Attack"
  ],
  [
    "Coldkill",
    "Coldkill"
  ...
  [
    "EskillPassiveFeral",
    "Passive Bonus to Wolves and Bears"
  ],
  [
    "Eskillperhit12",
    " per hit"
  ...
  [
    "qsta5q14",
    "Larzuk will add sockets to the item of your choice."
  ],
  [
    "qstsa5q42a",
  ...
  [
    "qstsa5q62a",
    "Kill Baal in the Worldstone Chamber before he corrupts it."
  ],
  [
    "qstsa5q61a",
  ...
  [
    "x",
    "Unable to enter game. Your character must kill Baal to play in a Nightmare game."
  ],
  [
    "x",
    "CREATE NEW"
  ...
  [
    "x",
    "Unable to access file. Cannot convert character."
  ],
  [
    "EskillPerBlade",
    " per blade"
  ...
  [
    "ItemExpansiveChancX",
    "%d%% Chance to cast level %d %s on attack"
  ],
  [
    "ItemExpansiveChanc1",
    "%d%% Chance to cast level %d %s on striking"
  ],
  [
    "ItemExpansiveChanc2",
    "%d%% Chance to cast level %d %s when struck"
  ],
  [
    "ItemExpcharmdesc",
    "Keep in inventory to gain bonus"
  ...
  [
    "EnterForgottenTAss",
    "Who would want to remember this place?"
  ],
  [
    "EnterForgottenTDru",
  ...
  [
    "EnterJailDru",
    "Bars can't hold a force of nature."
  ],
  [
    "EnterCatacombsAss",
  ...
  [
    "EnterCatacombsDru",
    "The supernatural is strong here."
  ],
  [
    "CompletingDOEAss",
  ...
  [
    "CompletingForgottenTPal",
    "So much treasure almost covers the stench."
  ],
  [
    "CompletingForgottenTPal",
  ...
  [
    ...
    "Return to dust, Radament."
  ],
  [
    "BeginTaintedSunAss",
    "An eclipse... never a good omen."
  ],
  [
    "BeginTaintedSunDru",
  ...
  [
    ...
    "The sun warms the world once more."
  ],
  [
    "EnteringArcaneAss",
  ...
  [
    "FindingSummonerAss",
    "Summoner, the dark magics have corrupted you."
  ],
  [
    "FindingSummonerDru",
    "This place would drive anyone mad."
  ],
  [
  ...
  [
    "FindingdecoyTombAss",
    "The Horadrim have left their mark here."
  ],
  [
    "FindingdecoyTombDru",
    "These Horadric markings are mysterious."
  ],
  [
    "FindingTrueTombAss",
    "I can sense Tal Rasha's presence now."
  ],
  [
    "FindingTrueTombDru",
    "So, Tal Rasha... This is your resting place."
  ],
  [
    "CompletingTombAss",
  ...
  [
    "FindingLamEsenAss",
    "Black books make for dark thoughts."
  ],
  [
    "FindingLamEsenDru",
    "An ancient manuscript...  This could be useful."
  ],
  [
  ...
  [
    ...
    "And I thought the Forgotten Tower stank."
  ],
  [
    "FindingBeneathCityDru",
    "This smells worse than the sewers of Lut Gohlein."
  ],
  [
    "FindingDrainLeverAss",
    "Levers are made to be pulled."
  ],
  [
    "FindingDrainLeverDru",
    "Finally... The drain lever."
  ],
  [
    "CompletingBeneathCityAss",
    "This is one drain I don't mind cleaning out."
  ],
  [
  ...
  [
    "CompletingBladeDru",
    "Ormus may know something about this unusual blade."
  ],
  [
    "FindingJadeFigAss",
    "Hmm, a jade statue. What should I do with it?"
  ],
  [
    "FindingJadeFigDru",
    "It looks like jade. Perhaps it's worth something."
  ],
  [
    "FindingTempleAss",
    "I dread this place of darkness."
  ],
  [
    "FindingTempleDru",
    "This temple is a nest of evil."
  ],
  [
    "CompletingTempleAss",
  ...
  [
    "FreezingIzualDru",
    "I have no pity for him. Oblivion is his reward."
  ],
  [
    "KillingdDiabloSor",
  ...
  [
    "KillingdDiabloDru",
    "Thus ends the plague of Terror."
  ],
  [
    "LeavingTownAct5Sor",
  ...
  [
    ...
    "Ahh, the familiar scent of death."
  ],
  [
  ...
  [
    ...
    "...Nihlathak's home away from home."
  ],
  [
  ...
  [
    ...
    "The fabled home of the Ancients."
  ],
  [
  ...
  [
    "Skillsd225",
    "passive - improves shape-shifting ability"
  ],
  [
    "Skillld225",
  ...
  [
    "Skillsd234",
    "maul your enemies - werebear form"
  ],
  [
    "Skillld234",
  ...
  [
    "Skillsd244",
    "create shock waves - werebear form"
  ],
  [
    "Skillld244",
  ...
  [
    "Skillsd253",
    "passive - improves claw-class weapons ability"
  ],
  [
    "Skillld253",
  ...
  [
    "Skillsd254",
    "a mind blast to crush your enemies"
  ],
  [
    "Skillld254",
  ...
  [
    "Skillsd264",
    "passive - block with two claw-class weapons"
  ],
  [
    "Skillld264",
  ...
  [
    "Skillsd277",
    "trap that explodes nearby corpses"
  ],
  [
    "Skillld277",
  ...
  [
    "Eskillsinishup",
    "Finishing Move Bonuses"
  ],
  [
    "Eskillpudlife",
    " percent life stealing"
  ],
  [
    "Eskillpudmana",
  ...
  [
    "qsta5q13",
    "Go talk to Larzuk for your reward."
  ],
  [
    "qstsa5q2",
  ...
  [
    "qstsa5q22",
    "Rescue %d more Soldiers in the Frigid Highlands."
  ],
  [
    "qstsa5q23",
  ...
  [
    "qstsa5q24",
    "Apply the Runes to a Socketed item in this order:"
  ],
  [
    "qstsa5q3",
    "Prison of Ice"
  ...
  [
    "qstsa5q64",
    "Take Tyreal's Portal to Safety."
  ],
  [
    "Harrogath",
    "Harrogath"
  ...
  [
    ...
    "To The Glacial Trail"
  ],
  [
    "To The Echo Chamber",
    "To The Drifter Cavern"
  ],
  [
  ...
  [
    ...
    "To The Halls of Pain"
  ],
  [
    "To The Halls of Tormented Insanity",
    "To The Halls of Torment"
  ],
  [
  ...
  [
    "hireiconinfo1",
    "Drop Potion on Portrait to Heal"
  ],
  [
    "hireiconinfo2",
    "Right-click to Open Inventory (%s)"
  ],
  [
    "hiredismiss",
    "Dismiss"
  ...
  [
    "hirepraise1",
    "It is good to work for someone who cares."
  ],
  [
    "hirepraise2",
    "Good for you."
  ...
  [
    "x",
    "NEW EXPANSION OPEN CHARACTER."
  ],
  [
    "x",
    "NEW EXPANSION REALM CHARACTER."
  ],
  [
    "X",
  ...
  [
    "Addsocketsui2",
    "Choose the item to which you wish to add sockets."
  ],
  [
    "MercX101",
    "Vardhaka"
...
const convStrings = Object.fromEntries(
  strings
    .slice(1723, strings.length)
    .filter(s => !!s)
    .filter(s => s[1].trim() !== '')
)
// .map(s => {
...
// console.log(
//   strings.length,
//   Object.keys(convStrings).length,
//   convStrings
// );

export default convStrings;